 ...
 */
package com.i3s.app.geneticalgorithm;

import com.i3s.app.common.Global;
import com.i3s.app.pattern.Pattern;
import com.i3s.app.pattern.computation.PatternComparator;
...
public class Population 
{
	...
	static String className = Population.class.getName();
    
    /**
     * Initialize a list of patterns.
     */
    public Population(Logger logFile)
    {
    ...
    {        
        ...
        logFile.log("INFO", className, "The list of individuals is composed by " + listIndividuals.size() + " patterns.");
        sort();
    }
