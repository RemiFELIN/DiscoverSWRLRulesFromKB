...
{	
	...
	public static String className = ConceptProcessing.class.getName();

	public ConceptProcessing(Logger logFile) {
	...
	public void queryClass(String szQuery, String szEndpoint) throws Exception
	{
		...
		logFile.log("INFO", className, "IRI Classes found :");
		...
		while (rs.hasNext()) {
			...
			logFile.log("INFO", className, iriClass.toString());
		...
		logFile.log("INFO", className, "END QUERY CLASS ...");
