...
import com.i3s.app.pattern.computation.PatternComputation;
...
//        RoleAtom newRoleInBody = new RoleAtom(roleAtom.getIRI());
    ...
    {        
        ...
        //Choose a variable from the list of variables, containing also the new variable created, and then remove the variabe�le chosen from the list
