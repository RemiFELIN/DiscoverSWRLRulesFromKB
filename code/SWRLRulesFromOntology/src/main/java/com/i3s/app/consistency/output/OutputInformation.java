 ...
 */
package com.i3s.app.consistency.output;
...
import com.i3s.app.consistency.pattern.Pattern;
...
public class OutputInformation 
{
   ...
   public static PrintStream print_file = null;
    ...
    /**
     * @param type could be true (if the text must be printed also in the console), false otherwise.
     * @return true if the text must be printed also in the console, false otherwise.
     */
