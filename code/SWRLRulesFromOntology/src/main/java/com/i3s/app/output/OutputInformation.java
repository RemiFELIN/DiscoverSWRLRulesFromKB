...
import com.i3s.app.atom.ConceptAtom;
import com.i3s.app.atom.RoleAtom;
...
import com.i3s.app.dataprocessing.individual.RoleIndividual;
import com.i3s.app.dataprocessing.individual.RoleIndividuals;
import com.i3s.app.dataprocessing.individual.ConceptIndividuals;
import com.i3s.app.geneticalgorithm.Population;
import com.i3s.app.pattern.Pattern;
                ...
                if (setSuperConcepts.contains(conceptAssertions.getIRIConcept()))
                {
                    ...
                    if (!setSubConcepts.isEmpty())
                    {
                        ...
                        for(IRI subConcept : setSubConcepts)
                            output.println("    " + String.valueOf(j++) + ". " + Atom.cutNameOfIRI(subConcept));
                    }    
                }
            }
        }
                ...
                if (setSubConcepts.contains(conceptAssertions.getIRIConcept()))
                {
                    ...
                    if (!setSuperConcepts.isEmpty())
                    {
                        ...
                        for(IRI superConcept : setSuperConcepts)
                            output.println("    " + String.valueOf(j++) + ". " + Atom.cutNameOfIRI(superConcept));
                    }    
                }
            }
        }
                ...
                if (setSuperRoles.contains(roleAssertions.getIRIRole()))
                {
                    ...
                    if (!setSubRoles.isEmpty())
                    {
                        ...
                        for(IRI subRole : setSubRoles)
                            output.println("    " + String.valueOf(j++) + ". " + Atom.cutNameOfIRI(subRole));
                    }    
                }
            }
        }
                ...
                if (setSubRoles.contains(roleAssertions.getIRIRole()))
                {
                    ...
                    if (!setSuperRoles.isEmpty())
                    {
                        ...
                        for(IRI superRole : setSuperRoles)
                            output.println("    " + String.valueOf(j++) + ". " + Atom.cutNameOfIRI(superRole));
                    }    
                }
            }
        }
                ...
                if (setOfRoles.contains(roleAssertions.getIRIRole()))
                {
                    ...
                    if (!setConceptsDomainOfRoles.isEmpty())
                    {
                        ...
                        for(IRI conceptDomain : setConceptsDomainOfRoles)
                            output.println("    " + String.valueOf(j++) + ". " + Atom.cutNameOfIRI(conceptDomain));
                    }    
                }
            }
        }
                    ...
                    if (!setConceptsDomainOfRoles.isEmpty())
                    {
                        ...
                        for(IRI conceptDomain : setConceptsDomainOfRoles)
                        {
                            ...
                            for(IRI iriConceptSubsum : iriListConceptsSubsum)
                                output.println("        " + String.valueOf(k++) + ". " + Atom.cutNameOfIRI(iriConceptSubsum));
                        }
                    }    
                }
            }
                ...
                if (setOfRoles.contains(roleAssertions.getIRIRole()))
                {
                    ...
                    if (!setConceptsRangeOfRoles.isEmpty())
                    {
                        ...
                        for(IRI conceptRange : setConceptsRangeOfRoles)
                            output.println("    " + String.valueOf(j++) + ". " + Atom.cutNameOfIRI(conceptRange));
                    }    
                }
            }
        }
    ...
    public static void showPattern(Pattern pattern, boolean type)
    {
        ...
        for (int i = 0; i < listAtoms.size(); i++)
        {
            ...
            if (atom instanceof ConceptAtom)
                output.print(((ConceptAtom) atom).getNameWithoutIRI() + "(" + ((ConceptAtom) atom).getVariable() + ")");
            else if (atom instanceof RoleAtom)
                output.print(((RoleAtom) atom).getNameWithoutIRI() + "(" + ((RoleAtom) atom).getDomainVariable() + ", " + ((RoleAtom) atom).getRangeVariable() + ")");
